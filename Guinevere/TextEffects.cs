...
public sealed record TextEffects
{
    ...
    /// <summary>Gradient used for the fill instead of the flat text colour.</summary>
    ...
    /// <param name="Color">Shadow colour (usually semi-transparent).</param>
    ...
    /// <param name="From">Colour at the start.</param>
    /// <param name="To">Colour at the end.</param>
