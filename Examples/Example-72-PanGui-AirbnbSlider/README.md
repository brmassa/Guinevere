# Example-72-PanGui-AirbnbSlider

This example demonstrates advanced shape composition, custom interactions, and high-fidelity visual effects in Guinevere, inspired by the Airbnb mobile app slider.
