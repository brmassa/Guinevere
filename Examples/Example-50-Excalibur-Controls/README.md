...
Merges `Example-50-Controls`, `Example-51-Buttons`, `Example-52-TextInput-MultiPlatform`, `Example-07-Scroll`
and `Example-11-Styling` into one example organised around eight tabs.
